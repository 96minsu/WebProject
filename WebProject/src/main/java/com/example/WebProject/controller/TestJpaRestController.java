 ...
 * 
 * import org.mariadb.jdbc.internal.logging.LoggerFactory; import
 ...
 * 
 * import com.example.WebProject.domain.dto.MemberVo; import
 * com.example.WebProject.service.MemberService;
 * 
 * @RestController
 * 
 * @RequestMapping("memberTest") public class TestJpaRestController { // 기본형
 ...
 * // 회원 입력
 * 
 * @PostMapping public ResponseEntity<MemberVo> save(MemberVo member) { return
 * new ResponseEntity<MemberVo>(memberService.save(member), HttpStatus.OK); }
 * 
 * // 회원 입력
 * 
 * @RequestMapping(value = "/saveMember", method = RequestMethod.GET) public
 * ResponseEntity<MemberVo> save(HttpServletRequest req, MemberVo member) {
